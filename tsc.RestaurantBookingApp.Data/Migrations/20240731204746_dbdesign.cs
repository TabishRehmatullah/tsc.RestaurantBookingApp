...
namespace tsc.RestaurantBookingApp.Data.Migrations
{
    /// <inheritdoc />
    public partial class dbdesign : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantBranche", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantBranche_Restaurant_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiningTable_RestaurantBranche_RestaurantBranchId",
                        column: x => x.RestaurantBranchId,
                        principalTable: "RestaurantBranche",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantBranche_RestaurantId",
                table: "RestaurantBranche",
                column: "RestaurantId");
